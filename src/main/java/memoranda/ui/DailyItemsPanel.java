...
public class DailyItemsPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        CurrentProject.addProjectListener(new IProjectListener() {
            public void projectChange(IProject p, NoteList nl, ITaskList tl, IResourcesList rl) {
...
//		Util.debug("currentNoteChanged");
    ...
    void currentProjectChanged(IProject newprj, NoteList nl, ITaskList tl, IResourcesList rl) {
